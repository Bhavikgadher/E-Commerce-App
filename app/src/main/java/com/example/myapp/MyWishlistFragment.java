...
public class MyWishlistFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        wishlistRecyclerView.findViewById( R.id.rv_my_wishlist );
        ...
        wishlistModelList.add( new WishlistModel( R.mipmap.ic_13_pro, "Iphone 13 pro", 0, "5", 145, "Rs.79,999/-", "Rs.88,999/-", "Case on Delivery" ) );
